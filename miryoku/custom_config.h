...
U_NP,              U_NP,              U_LT(U_NUM, BSPC), U_LT(U_SYM, RET), U_LT(U_FUN, DEL),   U_LT(U_MEDIA, TAB),U_LT(U_MOUSE, ESC),U_LT(U_NAV, SPACE),U_NP,              U_NP
...
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              &kp K_APP,         &kp ESC,           &kp SPACE,         U_NP,              U_NP
